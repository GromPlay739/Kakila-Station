...
air-alarm-ui-window-listing-title = {$address} : { -air-alarm-state-name }
...
air-alarm-ui-window-alarm-state = [color={$color}]{ -air-alarm-state-name }[/color]
air-alarm-ui-window-alarm-state-indicator = Status: [color={$color}]{ -air-alarm-state-name }[/color]
