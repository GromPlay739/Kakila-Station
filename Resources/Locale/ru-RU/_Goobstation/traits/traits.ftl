...
trait-phantom-pain-name = Цифровая фантомная боль
trait-phantom-pain-desc = У тебя очень реальное и очень серьёзное медицинское состояние, которое не выдумано и не для привлечения внимания. Когда тебя бьют, ты выходишь из роли, чтобы пожаловаться на это в LOOC.
